...
-- updater
Services = {
    updater = "https://xibatd.online/api/client/updates/windows-x64",
    ...
    clientAssets = {
        ...
        revisionManifestUrl = "https://storage.googleapis.com/principal-346712-xibat-client-downloads/assets/current/1098.json",
        timeout = 900,
        installSounds = false,
